...
const basePartners: Partner[] = [
  ...
  // Additional demo partners
  {
    id: 'demo-4',
    name: 'Creator Collective',
    companyName: 'Collective Studios',
    type: 'Person',
    clients: ['Demo Client'],
    website: 'https://creatorcollective.example.com',
    linkedin: 'https://www.linkedin.com/company/creatorcollective',
    reach: 200000,
    relationshipStatus: 'Active',
    relationshipDetail: 'Recurring co-marketing series each quarter.',
    progressStage: 'Live',
    tier: 'A',
    category: 'Media',
    persona: 'Creator',
    distroMediums: ['YouTube', 'Newsletter'],
    campaigns: ['Summer Series'],
    campaignDetail: 'Video + newsletter bundle',
    actionItems: 'Plan Q1 content calendar',
    rate: '$4k per bundle',
    hasEmail: true,
    hasRate: true,
    hasLinks: true,
    source: 'Manual',
    mediaProperties: ['YouTube', 'Newsletter'],
    subTypes: ['Influencer', 'Creator'],
    subType: 'Influencer',
    extraFields: {},
  },
  {
    ...
    linkedin: 'https://www.linkedin.com/company/northwindlabs',
    reach: 320000,
    relationshipStatus: 'Prospect',
    relationshipDetail: 'Intro call complete; awaiting proposal feedback.',
    progressStage: 'Contacted',
    tier: 'B',
    category: 'SaaS',
    persona: 'Tech Vendor',
    distroMediums: ['Podcast'],
    campaigns: ['Product Spotlight'],
    campaignDetail: 'Podcast sponsorship + landing page CTA',
    actionItems: 'Send media kit and pricing',
    rate: '',
    hasEmail: true,
    hasRate: false,
    hasLinks: true,
    source: 'Firecrawl',
    mediaProperties: ['Podcast'],
    subTypes: ['Publisher'],
    subType: 'Publisher',
    extraFields: {},
  },
  {
    id: 'demo-6',
    name: 'Harbor Events',
    companyName: 'Harbor Collective',
    type: 'Place',
    clients: ['Demo Client'],
    website: 'https://harborevents.example.com',
    linkedin: '',
    reach: 150000,
    relationshipStatus: 'Active',
    relationshipDetail: 'Signed venue partner for upcoming meetup series.',
    progressStage: 'Live',
    tier: 'A',
    category: 'Community',
    persona: 'Venue',
    distroMediums: ['Events'],
    campaigns: ['Meetup Series'],
    campaignDetail: 'Monthly in-person events',
    actionItems: 'Confirm catering partner',
    rate: '',
    hasEmail: false,
    hasRate: false,
    hasLinks: true,
  ...
  },
  {
    id: 'demo-7',
    name: 'Growth Grid',
    companyName: 'Growth Grid Media',
    type: 'Brand',
    clients: ['Demo Client'],
    website: 'https://growthgrid.example.com',
    linkedin: 'https://www.linkedin.com/company/growthgrid',
    reach: 90000,
    relationshipStatus: 'Prospect',
    relationshipDetail: 'Shared deck; scheduling pilot campaign.',
    progressStage: 'In discussion',
    tier: 'B',
    category: 'Marketing',
    persona: 'Publisher',
    distroMediums: ['LinkedIn', 'Newsletter'],
    campaigns: [],
    campaignDetail: '',
    actionItems: 'Finalize pilot budget',
    rate: '',
    hasEmail: true,
    hasRate: false,
    hasLinks: true,
